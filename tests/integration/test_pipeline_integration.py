    ...
    return pd.DataFrame(
        {
            ...
            "lactate_rise_12h_flag": np.random.randint(0, 2, n),
            "lactate_rise_24h_flag": np.random.randint(0, 2, n),
            "vis_rise_12h_flag": np.random.randint(0, 2, n),
            "vis_rise_24h_flag": np.random.randint(0, 2, n),
            "uo_decline_12h_flag": np.random.randint(0, 2, n),
            "uo_decline_24h_flag": np.random.randint(0, 2, n),
            "pressor_12h_flag": np.random.randint(0, 2, n),
            "pressor_24h_flag": np.random.randint(0, 2, n),
            "mcs_12h_flag": np.random.randint(0, 2, n),
            "mcs_24h_flag": np.random.randint(0, 2, n),
            "escalation_12h_flag": np.random.randint(0, 2, n),
            "escalation_24h_flag": np.random.randint(0, 2, n),
            "renal_injury_12h_flag": np.random.randint(0, 2, n),
            "renal_injury_24h_flag": np.random.randint(0, 2, n),
            "hypoperfusion_12h_flag": np.random.randint(0, 2, n),
            "hypoperfusion_24h_flag": np.random.randint(0, 2, n),
            "hepatic_injury_12h_flag": np.random.randint(0, 2, n),
            "hepatic_injury_24h_flag": np.random.randint(0, 2, n),
            "end_organ_12h_flag": np.random.randint(0, 2, n),
            "end_organ_24h_flag": np.random.randint(0, 2, n),
            "mortality_12h_flag": np.random.randint(0, 2, n),
            "mortality_24h_flag": np.random.randint(0, 2, n),
            "shock_progression_12h_flag": np.random.randint(0, 2, n),
